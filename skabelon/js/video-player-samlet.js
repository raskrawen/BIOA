...
(function (VideoPlayer, $, undefined) {
    ...
    VideoPlayer.InitPlayers = function(selector) {
        ...
        element.each(function(index) {
            ...
            var playBtn = $('<span class="new-player-play-icon"><img src="../skabelon/images/new-player-play.png" /></span>').appendTo(playPauseControl);
            var pauseBtn = $('<span class="new-player-pause-icon"><img src="../skabelon/images/new-player-pause.png" /></span>').appendTo(playPauseControl);
            ...
            if(settings.audio && !navigator.userAgent.match(/iPhone|iPad|iPod/i)) {
                ...
                var volumeIcon = $('<div class="volume-icon"><img src="../skabelon/images/new-player-audio.png" /></div>').appendTo(volumeControl).on("click", function() {
            ...
            if(settings.fullscreen) {
                var fullscreenBtn = $(' <div class="new-player-fullscreen"><img class="open-fullscreen" src="../skabelon/images/new-player-fullscreen.png" /><img class="close-fullscreen" src="../skabelon/images/new-player-close-fullscreen.png" /></div>').appendTo(controlsContainer);
            }
            var accessabilityBtn = $(' <div class="new-player-accessability"><img src="../skabelon/images/new-player-accessability.png" /></div>').appendTo(controlsContainer);
