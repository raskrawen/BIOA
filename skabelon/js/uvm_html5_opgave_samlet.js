...
var UVM = {
	...
	*****************************************************************/
    ...
    setHeader: function () {
        $('head').append('<link rel="stylesheet" href="../skabelon/css/video-player.css" type="text/css" />');
        $('head').append('<link rel="stylesheet" href="../skabelon/css/jquery-ui.css" type="text/css" />');
        $('head').append('<link rel="stylesheet" href="../skabelon/css/audio-player.css" type="text/css" />');
        $('head').append('<link rel="stylesheet" href="../skabelon/css/imageSlider.css" type="text/css" />');
        browser = {};
        ...
        if (navigator.userAgent.match(/iPhone|iPad|iPod/i) || navigator.userAgent.match(/NOKIA/i)) {
            ...
            $('head').append('<link rel="stylesheet" href="../skabelon/css/style_' + $("body").attr("data-fag") + '_ios.css" type="text/css" />');
        } else { //if IE 9.
            $('head').append('<link rel="stylesheet" href="../skabelon/css/style_' + $("body").attr("data-fag") + '.css" type="text/css" />');
        }
...
UVM.view = {
   ...
   *****************************************************************/
   ...
   funcLoadMenu: function(intSelectedPageId, intSelectedPageParentId) {
        ...
        $('#bottomMenu').html("<span class='subMenu' id='3' style='left: 0px;'><a onclick='UVM.view.funcLoadMenu(1, 1); UVM.view.funcLoadContent(1, 0);' target='_self' href='#'><img src='../skabelon/images/piltilbage.png' alt='' style='height: 0.9em; margin-bottom: -0.1em;'>TILBAGE</a></span>" + strMenu);
...
function doLoad() {
    ...
    videoPlayer("", "", "", "", false);
    initAudio();
    $("body").css("background-image", "url(../skabelon/images/bg.jpg)");
